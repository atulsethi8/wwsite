...
const Home = () => {
  ...
  },
  {
    ...
    location: "Indonesia",
    ...,
    url: "/bali-cultural-journey" // add this page when ready
  }
]
        ...
        <div className="container-custom">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Discover our most exclusive destinations, carefully curated for
              discerning travelers seeking extraordinary experiences
            </p>
          </motion.div>
        ...
        <div className="container-custom text-center">
          ...
          >
            ...
            <p className="text-xl text-white/90 mb-10 max-w-3xl mx-auto leading-relaxed">
              Let us craft the perfect bespoke travel experience tailored to
              your unique desires and preferences
            </p>
