...
const Destinations = () => {
  ...
  return (
    <div className="min-h-screen bg-[#fbf8f1] pt-20 text-[#173b40]">
      <section className="relative overflow-hidden bg-[#071f24] py-20 text-white lg:py-28">
        <div className="absolute inset-y-0 right-0 hidden w-[42%] bg-[url('https://images.unsplash.com/photo-1469474968028-56623f02e42e?auto=format&fit=crop&w=1200&q=80')] bg-cover bg-center opacity-35 lg:block" />
        <div className="absolute inset-0 bg-gradient-to-r from-[#071f24] via-[#071f24]/95 to-[#071f24]/20" />
