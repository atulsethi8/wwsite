...
const Hero = () => (
  <section className="relative min-h-[92vh] overflow-hidden bg-slate-950 text-white">
    <VideoBackground />
    <div className="absolute inset-0 z-10 bg-gradient-to-r from-[#06181e]/95 via-[#06181e]/78 to-[#06181e]/20" />
    <div className="absolute inset-0 z-10 bg-gradient-to-t from-[#06181e]/90 via-transparent to-[#06181e]/20" />
    <div className="container-custom relative z-20 flex min-h-[92vh] items-end pb-16 pt-36 lg:items-center lg:pb-8">
      <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.9 }} className="max-w-4xl rounded-sm bg-[#06181e]/20 py-3 backdrop-blur-[1px]">
