...
// ⭐ Utility for stars
const Stars = ({ count = 5 }) => (
  <div className="flex items-center justify-center gap-0.5 text-amber-500 mb-2" aria-label={`${count} star rating`}>
...
const slides = [
  ...
  },
  {
    ...
    text:
      "WanderWyze is a brilliant travel curator—bespoke advice after customising our travel itinerary to Australia. Ravinder arranged a stayover in Singapore and handled last-minute activity changes. Personalisation > automated itineraries. Best experience—we’ll use them for all future plans.",
  },
  {
    name: "Mayank Awasthi",
    place: "",
  ...
  },
  {
    ...
    text:
      "Traveling with Wander Wyze was one of the best decisions I’ve made! Thoughtfully curated hotels, activities and routes—it wasn’t just a holiday, it was an experience. Everything ran like clockwork and the team helped instantly whenever needed. Wholeheartedly recommend—already dreaming up the next trip!",
  },
];
    ...
    <div className="relative bg-white rounded-2xl shadow-xl p-8 md:p-10">
      ...
      <div className="absolute -top-10 left-1/2 -translate-x-1/2">
        <img
          src={t.img}
          alt={`${t.name} avatar`}
          className="h-20 w-20 rounded-full object-cover ring-4 ring-white shadow-md bg-gray-200"
          onError={(e) => {
      ...
      <div className="mt-8 text-center">
        ...
        {/* Review text with opening & closing quotes */}
        <div className="relative">
          <Quote
            aria-hidden="true"
            className="absolute -top-3 -left-3 h-6 w-6 text-primary-600/60"
          />
          ...
          <Quote
            aria-hidden="true"
            className="absolute -bottom-3 -right-3 h-6 w-6 text-primary-600/60 rotate-180"
          />
        </div>
        ...
        <a
          ...
          className="inline-block mt-6 text-primary-600 hover:text-primary-700 font-medium underline underline-offset-4"
        >
